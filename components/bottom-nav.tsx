...
const moreNavItems = [
  ...
  { name: "Templates", href: "/templates", icon: LayoutTemplate, colorClass: "from-pink-400/10 to-pink-400/5 border-pink-400/20 text-pink-400 group-hover:from-pink-400/20 group-hover:to-pink-400/10 group-hover:shadow-pink-400/25", textHover: "group-hover:text-pink-400" },
  { name: "Marketplace", href: "/marketplace", icon: Store, colorClass: "from-green-400/10 to-green-400/5 border-green-400/20 text-green-400 group-hover:from-green-400/20 group-hover:to-green-400/10 group-hover:shadow-green-400/25", textHover: "group-hover:text-green-400" },
  { name: "Business Card", href: "/business-card", icon: IdCard, colorClass: "from-amber-400/10 to-amber-400/5 border-amber-400/20 text-amber-400 group-hover:from-amber-400/20 group-hover:to-amber-400/10 group-hover:shadow-amber-400/25", textHover: "group-hover:text-amber-400" },
  { name: "Reputation", href: "/reputation", icon: Star, colorClass: "from-yellow-400/10 to-yellow-400/5 border-yellow-400/20 text-yellow-400 group-hover:from-yellow-400/20 group-hover:to-yellow-400/10 group-hover:shadow-yellow-400/25", textHover: "group-hover:text-yellow-400" },
