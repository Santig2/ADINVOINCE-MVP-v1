...
export function ShareLinkDialog({
  ...
  const prefix = documentType === "invoice" ? "inv" : documentType === "estimate" ? "est" : documentType === "advance" ? "adv" : "rev";
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogTitle className="text-center text-2xl">
            {documentType.charAt(0).toUpperCase() + documentType.slice(1)} Ready to Share!
          </DialogTitle>
          <DialogDescription className="text-center">
            Your document has been generated successfully. Share this link with your client so they can view and interact with it.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex items-center space-x-2 mt-4">
          ...
          />
          <Button size="icon" onClick={handleCopy} className="shrink-0" variant={copied ? "default" : "secondary"}>
        ...
        <DialogFooter className="sm:justify-between mt-6">
          <Link href={shareLink} target="_blank" className="text-sm text-primary flex items-center hover:underline">
