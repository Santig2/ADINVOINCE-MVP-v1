      ...
      >
        <Card className="border-border/50 shadow-2xl bg-card/95 backdrop-blur">
          <CardHeader className="space-y-4 text-center pb-8">
            ...
            <CardTitle className="text-2xl font-bold text-foreground">Welcome to AddInvoices</CardTitle>
          ...
          <CardContent>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-muted-foreground">AddInvoices — Powered by ADSTRATEGIC</p>
            </div>
          </CardContent>
        </Card>
      </motion.div>
