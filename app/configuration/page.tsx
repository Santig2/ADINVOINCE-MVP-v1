...
import { Upload, Save, Plus, Trash2, Building2, User, FileText, SettingsIcon, CheckCircle2, CreditCard, Wallet, Send, Smartphone, Download, Database, TableProperties, FileSpreadsheet, LayoutTemplate, Store, IdCard, Star, ExternalLink, Puzzle } from "lucide-react"
    ...
    <AppLayout>
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        ...
        <Accordion type="single" collapsible defaultValue="user" className="flex flex-col gap-4 max-w-4xl mx-auto mt-4 pb-20">
          ...
          <AccordionItem value="addons" className="border border-white/10 dark:border-white/5 rounded-2xl bg-gradient-to-br from-card/60 to-card/20 backdrop-blur-xl shadow-sm overflow-hidden data-[state=open]:border-purple-500/30 data-[state=open]:shadow-md data-[state=open]:shadow-purple-500/10 transition-all duration-300">
            <AccordionTrigger id="config-addons" className="px-6 py-4 hover:bg-card/50 hover:no-underline group transition-all [&[data-state=open]>svg]:rotate-180">
              <div className="flex items-center gap-4 text-left flex-1">
                <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/20 text-purple-500 flex items-center justify-center shrink-0 group-data-[state=open]:scale-110 group-data-[state=open]:bg-purple-500/20 transition-all duration-300 shadow-inner">
                  <Puzzle className="h-5 w-5 drop-shadow-sm" />
                </div>
                <div className="flex flex-col items-start text-left">
                  <span className="font-semibold text-foreground text-base group-hover:text-purple-500 transition-colors">Tools & Integrations</span>
                  <span className="text-xs text-muted-foreground font-normal mt-0.5">Extra tools to supercharge your business</span>
                </div>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6 pt-2">
              <div className="animate-in fade-in slide-in-from-top-4 duration-500 grid md:grid-cols-2 gap-4">
                
                {/* Templates */}
                <Card className="hover:border-primary/50 transition-colors cursor-pointer bg-secondary/30">
                  <Link href="/templates">
                    <CardContent className="p-6 flex items-start gap-4 h-full">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="font-bold">Invoice Templates</h4>
                          <ExternalLink className="w-4 h-4 text-muted-foreground" />
                        </div>
                        <p className="text-sm text-muted-foreground mt-1">Configure default templates for your business models.</p>
                      </div>
                    </CardContent>
                  </Link>
                </Card>
                ...
                <Card className="hover:border-primary/50 transition-colors cursor-pointer bg-secondary/30">
                  <Link href="/marketplace">
                    <CardContent className="p-6 flex items-start gap-4 h-full">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="font-bold">Marketplace Connections</h4>
                          <ExternalLink className="w-4 h-4 text-muted-foreground" />
                        </div>
                        <p className="text-sm text-muted-foreground mt-1">Connect Yelp, Nextdoor, Care.com, and Google.</p>
                      </div>
                    </CardContent>
                  </Link>
                </Card>
                ...
                <Card className="hover:border-primary/50 transition-colors cursor-pointer bg-secondary/30">
                  <Link href="/business-card">
                    <CardContent className="p-6 flex items-start gap-4 h-full">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="font-bold">Digital Business Card</h4>
                          <ExternalLink className="w-4 h-4 text-muted-foreground" />
                        </div>
                        <p className="text-sm text-muted-foreground mt-1">Generate and manage your smart business card.</p>
                      </div>
                    </CardContent>
                  </Link>
                </Card>
                ...
                <Card className="hover:border-primary/50 transition-colors cursor-pointer bg-secondary/30">
                  <Link href="/reputation">
                    <CardContent className="p-6 flex items-start gap-4 h-full">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h4 className="font-bold">Reputation Management</h4>
                          <ExternalLink className="w-4 h-4 text-muted-foreground" />
                        </div>
                        <p className="text-sm text-muted-foreground mt-1">Configure automated review filtering by Botsy.</p>
                      </div>
                    </CardContent>
                  </Link>
                </Card>
